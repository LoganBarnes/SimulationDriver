...
CallbackWrapper<C1, C2>::CallbackWrapper(C1 *pCallbacks1, C2 *pCallbacks2)
        : pCallbacks1_(pCallbacks1),
          pCallbacks2_{pCallbacks2} {}
...
template<typename C>
auto
CallbackWrapper<C1, C2>::mouseButtonCallback(C &callbacks, GLFWwindow *window, int button, int action, int mods, int)
-> decltype(callbacks.mouseButtonCallback(window, button, action, mods), void())
{
