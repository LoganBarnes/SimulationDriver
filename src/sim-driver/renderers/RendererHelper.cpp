...
template<typename Vertex>
int RendererHelper<Vertex>::getFboWidth() const { return fboWidth_; }
template<typename Vertex>
int RendererHelper<Vertex>::getFboHeight() const { return fboHeight_; }
template<typename Vertex>
bool RendererHelper<Vertex>::isShowingVertsOnly() const { return showingVertsOnly_; }
template<typename Vertex>
bool RendererHelper<Vertex>::isUsingWireframe() const { return usingWireframe_; }
template<typename Vertex>
bool RendererHelper<Vertex>::isShowNormals() const { return showNormals_; }
template<typename Vertex>
int RendererHelper<Vertex>::getDisplayMode() const { return displayMode_; }
template<typename Vertex>
const glm::vec3 &RendererHelper<Vertex>::getShapeColor() const { return shapeColor_; }
template<typename Vertex>
float RendererHelper<Vertex>::getShapeRoughness() const { return shapeRoughness_; }
template<typename Vertex>
const glm::vec3 &RendererHelper<Vertex>::getShapeIor() const { return shapeIor_; }
template<typename Vertex>
const glm::vec3 &RendererHelper<Vertex>::getLightDir() const { return lightDir_; }
template<typename Vertex>
int RendererHelper<Vertex>::getPointSize() const { return pointSize_; }
template<typename Vertex>
float RendererHelper<Vertex>::getNormalScale() const { return normalScale_; }
template<typename Vertex>
GLenum RendererHelper<Vertex>::getDrawMode() const { return drawMode_; }

template<typename Vertex>
void RendererHelper<Vertex>::setFboWidth(int fboWidth) { fboWidth_ = fboWidth; }
template<typename Vertex>
void RendererHelper<Vertex>::setFboHeight(int fboHeight) { fboHeight_ = fboHeight; }
template<typename Vertex>
void RendererHelper<Vertex>::setShowingVertsOnly(bool showingVertsOnly) { showingVertsOnly_ = showingVertsOnly; }
template<typename Vertex>
void RendererHelper<Vertex>::setUsingWireframe(bool usingWireframe) { usingWireframe_ = usingWireframe; }
template<typename Vertex>
void RendererHelper<Vertex>::setShowNormals(bool showNormals) { showNormals_ = showNormals; }
template<typename Vertex>
...
template<typename Vertex>
void RendererHelper<Vertex>::setShapeColor(const glm::vec3 &shapeColor) { shapeColor_ = shapeColor; }
template<typename Vertex>
void RendererHelper<Vertex>::setShapeRoughness(float shapeRoughness) { shapeRoughness_ = shapeRoughness; }
template<typename Vertex>
void RendererHelper<Vertex>::setShapeIor(const glm::vec3 &shapeIor) { shapeIor_ = shapeIor; }
template<typename Vertex>
void RendererHelper<Vertex>::setLightDir(const glm::vec3 &lightDir) { lightDir_ = lightDir; }
template<typename Vertex>
...
template<typename Vertex>
void RendererHelper<Vertex>::setNormalScale(float normalScale) { normalScale_ = normalScale; }
template<typename Vertex>
...
template<typename Vertex>
void RendererHelper<Vertex>::setDrawMode(GLenum drawMode) { drawMode_ = drawMode; }
