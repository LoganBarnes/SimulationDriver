...
public:
    ...
    ~RendererHelper() override = default;
    RendererHelper(const RendererHelper &) = default;
    RendererHelper(RendererHelper &&) noexcept = default;
    RendererHelper &operator=(const RendererHelper &) = default;
    RendererHelper &operator=(RendererHelper &&) noexcept = default;
