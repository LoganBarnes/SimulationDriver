...
auto make_child(priority_tag<2>, int w, int h, SimData *pSimData, Args ...args) -> decltype(T(w,
                                                                                              h,
                                                                                              pSimData,
                                                                                              args...)) {
...
template<typename T, typename ... Args>
auto make_child(priority_tag<1>, int w, int h, SimData *, Args ...args) -> decltype(T(w, h, args...)) {
  return T(w, h, args...);
}

template<typename T, typename ... Args>
auto make_child(priority_tag<0>, int, int, SimData *, Args ...args) -> decltype(T(args...)) {
  return T(args...);
}
